			...
			<div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
				<div class="tab-pane fade show" id="pills-home-nobd" role="tabpanel" aria-labelledby="pills-home-tab-nobd">
					...
					if (isset($_POST['changePassword'])) {
						...
						$query = mysqli_query($con, "SELECT password FROM tb_pelatih WHERE id_pelatih='$data[id_pelatih]'");
						...
						if (password_verify($passLama, $passDatabase)) {
							...
							$set = mysqli_query($con, "UPDATE tb_pelatih SET password='$newPass' WHERE id_pelatih='$data[id_pelatih]' ");
				...
				<div class="tab-pane fade" id="pills-profile-nobd" role="tabpanel" aria-labelledby="pills-profile-tab-nobd">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="hidden" name="id" value="<?= $data['id_pelatih'] ?>">
						</div>
						<div class="form-group">
					...
					if (isset($_POST['updateProfile'])) {
						...
						if (!empty($gambar)) {
							...
							$ganti = mysqli_query($con, "UPDATE tb_pelatih SET foto='$gambar' WHERE id_pelatih='$_POST[id]' ");
							if ($ganti) {
								echo "
													<script>
                        const Toast = Swal.mixin({
